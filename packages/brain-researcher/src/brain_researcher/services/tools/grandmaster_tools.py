...
class LoadDatasetArgs(BaseModel):
    bids_root: Optional[str] = Field(
        default=None, description="Path to BIDS dataset root"
    )
    bids_dir: Optional[str] = Field(default=None, description="Alias for bids_root")
...
class RunBIDSAppArgs(BaseModel):
    ...
    work_dir: Optional[str] = Field(default=None, description="Optional work directory")
    fs_license_file: Optional[str] = Field(
        default=None, description="Optional FreeSurfer license file"
    )
    bids_filter_file: Optional[str] = Field(
    ...
    n_cpus: Optional[int] = Field(default=None, description="Optional CPU count")
    omp_nthreads: Optional[int] = Field(
        default=None, description="Optional OpenMP thread count"
    )
    mem_mb: Optional[int] = Field(default=None, description="Optional memory in MB")
    n_procs: Optional[int] = Field(
    ...
    extra_args: Optional[list[str]] = Field(default=None, description="Extra CLI args")
    dry_run: bool = Field(
        default=False,
...
class GetQCTableTool(NeuroToolWrapper):
    ...
    def _run(
        self,
        qc_tsv: Optional[str] = None,
        mriqc_dir: Optional[str] = None,
        modality: str = "bold",
...
class DetectOutliersArgs(BaseModel):
    ...
    output_file: Optional[str] = Field(
        default=None, description="Output CSV of outliers"
    )
...
class StandardizeConfoundsArgs(BaseModel):
    ...
    output_file: Optional[str] = Field(default=None, description="Output TSV path")
...
class ResampleImageArgs(BaseModel):
    ...
    output_file: Optional[str] = Field(default=None, description="Output NIfTI path")
...
class AnalyzeGraphTopologyTool(NeuroToolWrapper):
    ...
    def _run(
        self, connectivity_file: str, output_dir: Optional[str] = None, **_: Any
    ) -> ToolResult:
...
class RunGLMFirstLevelArgs(BaseModel):
    ...
    events: Optional[str] = Field(
        default=None, description="Path to events.tsv or 'auto'"
    )
    t_r: Optional[float] = Field(default=None, description="TR in seconds")
...
class RunGLMSecondLevelArgs(BaseModel):
    ...
    design_matrix: Optional[str | dict] = Field(
        default=None, description="Design matrix or path"
    )
    contrast: Optional[str | list[float]] = Field(
...
class FilterEventsTool(NeuroToolWrapper):
    ...
    def _run(
        self, events_tsv: str, query: str, output_file: Optional[str] = None, **_: Any
    ) -> ToolResult:
        try:
            import pandas as pd
...
class PPIAnalyzerArgs(BaseModel):
    ...
    seed_mask: Optional[str] = Field(default=None, description="Seed mask NIfTI")
    confounds: Optional[str | list[str]] = Field(
...
class PPIAnalyzerTool(NeuroToolWrapper):
    ...
    def _run(self, **kwargs: Any) -> ToolResult:
        ...
        for idx, (img_path, events_path, conf_path) in enumerate(
            zip(imgs, events_list, conf_list)
        ):
...
class RunTractographyArgs(BaseModel):
    dwi: Optional[str] = Field(default=None, description="DWI NIfTI path")
    bvec: Optional[str] = Field(default=None, description="bvec path (preferred)")
    bval: Optional[str] = Field(default=None, description="bval path (preferred)")
    bvecs: Optional[str] = Field(default=None, description="Alias for bvec")
    bvals: Optional[str] = Field(default=None, description="Alias for bval")
    qsiprep_dir: Optional[str] = Field(
        default=None,
...
class RunTractographyTool(NeuroToolWrapper):
    ...
    def _run(
        ...
        bvec: Optional[str] = None,
        bval: Optional[str] = None,
        bvecs: Optional[str] = None,
        bvals: Optional[str] = None,
        qsiprep_dir: Optional[str] = None,
        participant_label: Optional[list[str]] = None,
        output_dir: Optional[str] = None,
        **_: Any,
    ) -> ToolResult:
...
class BuildStructuralConnectomeArgs(BaseModel):
    streamlines: Optional[str] = Field(
        default=None, description="Streamlines file (e.g., .trk/.tck/.npy)"
    )
    tractogram: Optional[str] = Field(default=None, description="Alias for streamlines")
...
class ExtractBundleStatsArgs(BaseModel):
    tool_hint: Optional[str] = Field(default=None, description="Optional backend hint")
...
class ExtractBundleStatsTool(NeuroToolWrapper):
    ...
    def _run(self, tool_hint: Optional[str] = None, **_: Any) -> ToolResult:
        return ToolResult(
            status="error",
...
class HarmonizeDataArgs(BaseModel):
    ...
    provenance_file: Optional[str] = Field(
...
class SearchToolsTool(NeuroToolWrapper):
    ...
    def _run(self, query: str, limit: int = 20, **_: Any) -> ToolResult:
        try:
            ...
            return ToolResult(
                status="success", data=mcp_server.tool_search(query=query, limit=limit)
            )
        except Exception as exc:
...
class SearchDatasetsArgs(BaseModel):
    ...
    task: Optional[str] = Field(default=None, description="Task filter")
    min_subjects: Optional[int] = Field(
        default=None, description="Minimum subject count"
    )
    limit: int = Field(default=20, ge=1, le=100, description="Max results")
...
class SearchLiteratureTool(NeuroToolWrapper):
    ...
    def _run(
        ...
        **_: Any,
        ...
        from brain_researcher.services.tools.neurokg_tools import LiteratureSearchTool
...
class ConsultKnowledgeGraphArgs(BaseModel):
    ...
    end_node: Optional[str] = Field(default=None, description="Optional end node")
...
class ConsultKnowledgeGraphTool(NeuroToolWrapper):
    ...
    def _run(self, **kwargs: Any) -> ToolResult:
        from brain_researcher.services.tools.neurokg_tools import GraphQueryTool

        return _call_wrapper(GraphQueryTool(), kwargs)


class DecodeBrainMapArgs(BaseModel):
    stat_map: Optional[str] = Field(default=None, description="Path to stat map")
    coordinates: Optional[list[list[float]]] = Field(
    ...
    def _run(
        ...
        **_: Any,
        ...
        try:
            ...
            neurovlm_error: Optional[str] = None
            if stat_map:
                try:
...
class RunSearchlightArgs(BaseModel):
    ...
    output_dir: str = Field(description="Output directory")
    labels_file: Optional[str] = Field(default=None, description="Labels file")
...
class ParcellateCiftiArgs(BaseModel):
    cifti_in: Optional[str] = Field(
        default=None, description="Input CIFTI/GIFTI/volume file"
    )
    cifti_file: Optional[str] = Field(default=None, description="Alias for cifti_in")
    atlas: str = Field(description="Atlas/parcellation definition")
    output_dir: Optional[str] = Field(default=None, description="Output directory")
    output_file: Optional[str] = Field(default=None, description="Optional output file")
...
class AnalyzeLongitudinalLMEArgs(BaseModel):
    ...
    output_file: Optional[str] = Field(default=None, description="Output summary path")
...
class PlotBrainMapArgs(BaseModel):
    ...
    threshold: Optional[float | str] = Field(
...
class PlotBrainMapTool(NeuroToolWrapper):
    ...
    def _run(
        ...
        stat_map: str,
        output_file: Optional[str] = None,
        threshold: Optional[float | str] = "auto",
...
class PlotMatrixArgs(BaseModel):
    ...
    output_file: Optional[str] = Field(default=None, description="Output PNG path")
    title: Optional[str] = Field(default=None, description="Plot title")
...
class VisualizeInteractiveArgs(BaseModel):
    ...
    output_file: Optional[str] = Field(default=None, description="Output HTML path")
...
class GenerateStudyReportArgs(BaseModel):
    ...
    output_file: Optional[str] = Field(default=None, description="Output Markdown path")
...
class RequestUserReviewTool(NeuroToolWrapper):
    ...
    def _run(
        self, message: str, artifacts: Optional[dict[str, str]] = None, **_: Any
    ) -> ToolResult:
        return ToolResult(
            status="success",
            data={
