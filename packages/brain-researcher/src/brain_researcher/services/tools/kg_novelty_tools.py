...
from brain_researcher.services.agent.principle_controller import (
...
class FindStructuralLeverageTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.find_structural_leverage"
...
class DetectContradictionMotifsTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.detect_contradiction_motifs"
...
class FindContradictionFrontiersTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.find_contradiction_frontiers"
...
class MineAssumptionCracksTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.mine_assumption_cracks"
...
class FindAnalogyTransfersTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.find_analogy_transfers"
...
class SynthesizeWowCandidateCardsTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.synthesize_wow_candidate_cards"
...
class PrincipleStateInitTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.principle_state_init"
...
class SampleOODHypothesisTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.sample_ood_hypothesis"
...
class DetectTopologyShiftsTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.detect_topology_shifts"
...
class PrincipleStateUpdateTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.principle_state_update"
...
class SynthesizeHypothesisCandidateCardsTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.synthesize_hypothesis_candidate_cards"

    def get_tool_description(self) -> str:
        return (
            "Rewrite verified KG hypothesis candidates into structured idea/hypothesis cards."
        )
...
class VerifySampledHypothesesTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.verify_sampled_hypotheses"
...
class SampleAndVerifyHypothesesTool(NeuroToolWrapper):
    def get_tool_name(self) -> str:
        return "neurokg.sample_and_verify_hypotheses"
