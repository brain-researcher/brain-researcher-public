    ...
    *,
    ...
    is_read_only_discovery = (
        ...
        and (
            ...
            or normalized_name.startswith(("datasets.", "neurokg.", "openneuro."))
        )
    )
...
class ToolSpec(BaseModel):
    ...
    # Core identity
    name: str = Field(
        description="Tool identifier (canonical runtime ID like 'fsl_bet' or namespaced public ID like 'neurokg.client')"
    )
