...
from brain_researcher.services.tools.neurokg_tools import NeuroKGTools
from brain_researcher.services.tools.kg_novelty_tools import KGNoveltyTools
from brain_researcher.services.tools.neurokg_query_tool import NeuroKGQueryTools
...
try:
    ...
    from brain_researcher.services.agent.plugin_integration import AgentPluginManager
...
class ToolRegistry:
    ...
    def _register_core_tools_light(self):
        ...
        try:
            ...
            neurokg_tools = NeuroKGTools()
            for tool in neurokg_tools.get_all_tools():
                self.register_tool(tool)
            logger.info(
                f"[light] Registered {len(neurokg_tools.get_all_tools())} BR-KG tools"
            )
        except Exception as e:
    ...
    def _full_discovery(self):
        ...
        from brain_researcher.services.tools.clinical_decision_support import (
    ...
    def get_runtime_tool(self, tool_id: str) -> Optional[NeuroToolWrapper]:
