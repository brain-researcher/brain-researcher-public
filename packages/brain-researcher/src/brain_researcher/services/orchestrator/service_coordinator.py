...
from .env import AGENT_URL, NEUROKG_URL, WEB_UI_URL
...
class ServiceRegistry:
    ...
    async def _check_endpoint_health(self, endpoint: ServiceEndpoint):
        ...
        try:
            ...
            health_data = await circuit_breaker.call(health_check)
...
class ServiceCoordinator:
    ...
    def __init__(self, load_balancing_config: Optional[LoadBalancingConfig] = None):
    ...
    async def _register_default_services(self):
        ...
        default_services = [
            ...
            ServiceEndpoint(
                ...
                service_type=ServiceType.NEUROKG,
                url=NEUROKG_URL,
                weight=10,
                priority=1,
