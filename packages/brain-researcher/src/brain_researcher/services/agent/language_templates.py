...
class Template:
    ...
    def get_content(self, language: Language, level: ExplanationLevel) -> Optional[TemplateContent]:
...
class LanguageTemplates:
            ...
            content={
                Language.ENGLISH: {
                    ExplanationLevel.TECHNICAL: TemplateContent(
                        ...
                        fields=["method", "n_subjects", "threshold", "correction", "peak_coords", 
                               "t_value", "p_value", "cluster_volume"]
                    ),
                    ExplanationLevel.LAYMAN: TemplateContent(
                        ...
                        fields=["n_subjects", "num_regions", "region_name", "function", "interpretation"]
                    ),
                    ExplanationLevel.STRUCTURED: TemplateContent(
                        ...
                        fields=["method", "n_subjects", "main_finding", "significance", "clinical_relevance"]
                    )
                },
                Language.SPANISH: {
                    ExplanationLevel.TECHNICAL: TemplateContent(
            ...
            content={
                Language.ENGLISH: {
                    ExplanationLevel.TECHNICAL: TemplateContent(
                        ...
                        fields=["error_type", "error_message", "stack_trace", "suggested_fix"]
                    ),
                    ExplanationLevel.LAYMAN: TemplateContent(
                    ...
                    ExplanationLevel.STRUCTURED: TemplateContent(
                        ...
                        fields=["error_type", "error_message", "possible_causes", 
                               "recommended_actions", "error_id"]
                    )
                },
                Language.SPANISH: {
                    ExplanationLevel.LAYMAN: TemplateContent(
            ...
            content={
                Language.ENGLISH: {
                    ExplanationLevel.TECHNICAL: TemplateContent(
                        ...
                        fields=["current_step", "total_steps", "step_name", "elapsed_time", 
                               "eta", "cpu_usage", "memory_usage"]
                    ),
                    ExplanationLevel.LAYMAN: TemplateContent(
                        ...
                        fields=["step_description", "progress_percentage", "estimated_duration"]
                    ),
            ...
            content={
                Language.ENGLISH: {
                    ExplanationLevel.TECHNICAL: TemplateContent(
                        ...
                        fields=["effect_type", "effect_size", "cohens_d", "ci_lower", "ci_upper",
                               "power", "alpha", "correction_method"]
                    ),
                    ExplanationLevel.LAYMAN: TemplateContent(
                        ...
                        fields=["plain_language_finding", "effect_magnitude", "confidence_level",
                    ...
                    ExplanationLevel.STRUCTURED: TemplateContent(
                        ...
                        fields=["main_finding", "effect_size", "magnitude_interpretation",
                               "confidence_interval", "power_analysis", "interpretation"]
                    )
                }
            }
        )
            ...
            content={
                Language.ENGLISH: {
                    ExplanationLevel.TECHNICAL: TemplateContent(
                        ...
                        fields=["analysis_type", "software_packages", "preprocessing_steps",
                               "statistical_model", "n_regressors", "threshold_method",
                               "threshold_value", "correction_method"]
                    ),
                    ExplanationLevel.LAYMAN: TemplateContent(
                    ...
                    ExplanationLevel.STRUCTURED: TemplateContent(
                        ...
                        fields=["analysis_type", "data_processing", "statistical_approach",
                               "quality_control", "validation_methods"]
                    )
                }
            }
        )
            ...
            content={
                Language.ENGLISH: {
                    ExplanationLevel.TECHNICAL: TemplateContent(
                        ...
                        fields=["primary_citation", "additional_references", 
                               "software_citations", "methodology_reference"]
                    ),
                    ExplanationLevel.LAYMAN: TemplateContent(
                    ...
                    ExplanationLevel.STRUCTURED: TemplateContent(
                        ...
                        fields=["primary_reference", "software_references",
                               "related_references", "further_reading"]
                    )
                }
            }
        )
    ...
    def get_template(self, category: TemplateCategory, language: Language = Language.ENGLISH,
                    level: ExplanationLevel = ExplanationLevel.TECHNICAL) -> Optional[TemplateContent]:
    ...
    def format_template(self, category: TemplateCategory, values: Dict[str, Any],
                       language: Language = Language.ENGLISH,
                       level: ExplanationLevel = ExplanationLevel.TECHNICAL) -> Optional[str]:
        """Format template with provided values"""
        template_content = self.get_template(category, language, level)
        if not template_content:
            logger.warning(f"Template not found: {category.value}, {language.value}, {level.value}")
            return None
        
        try:
            # Check for missing required fields
            missing_fields = [field for field in template_content.fields if field not in values]
            if missing_fields:
    ...
    def get_template_fields(self, category: TemplateCategory, 
                           language: Language = Language.ENGLISH,
                           level: ExplanationLevel = ExplanationLevel.TECHNICAL) -> List[str]:
    ...
    def validate_template_values(self, category: TemplateCategory, values: Dict[str, Any],
                                language: Language = Language.ENGLISH,
                                level: ExplanationLevel = ExplanationLevel.TECHNICAL) -> List[str]:
...
class NeuroimagingTemplates:
    ...
    @staticmethod
    def create_activation_summary(coordinates: List[float], region: str, 
                                 t_value: float, language: Language = Language.ENGLISH) -> str:
...
class StatisticalTemplates:
    ...
    @staticmethod
    def create_significance_statement(p_value: float, alpha: float = 0.05,
...
if __name__ == "__main__":
    ...
    missing = templates.validate_template_values(
        TemplateCategory.ANALYSIS_COMPLETE, {"method": "GLM"}, 
        Language.ENGLISH, ExplanationLevel.TECHNICAL
    )
