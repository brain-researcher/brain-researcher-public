        ...
        for spec in specs:
            ...
            if has_dataset and any(
                ...
                if "inventory" in spec_tags:
                    score += 1
            if (has_brain_region or has_concept) and "neurokg" in (spec.tags or []):
                score += 2
            ...
            if evidence_has_datasets and any(
                ...
                if "inventory" in spec_tags:
                    score += 1
            if evidence_has_kg_nodes and "neurokg" in (spec.tags or []):
                score += 2  # Boost KG-related tools
            if evidence_has_niclip and "neurokg" in (spec.tags or []):
