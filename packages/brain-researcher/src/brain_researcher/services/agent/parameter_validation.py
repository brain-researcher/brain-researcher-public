...
class ValidationRule:
    ...
    choices: Optional[List[Any]] = None  # For enum types
    custom_validator: Optional[Callable] = None
    file_extensions: Optional[List[str]] = None  # For file types
    array_shape: Optional[tuple] = None  # For numpy arrays
    array_dtype: Optional[Type] = None
...
class ParameterSchema:
    ...
    neurodesk_module: Optional[str] = None  # Required Neurodesk module
    source: Optional[str] = None  # Where this schema came from
    empirical_advice: Optional[str] = None  # Domain-specific recommendations
...
class ValidationSummary(dict):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        warnings: Optional[List[str]] = None,
        results: Optional[Dict[str, ParameterValidationResult]] = None,
...
class NeuroimagingValidators:
    ...
    def validate_path_security(path: str, strict: bool = True) -> bool:
        ...
        """
        from brain_researcher.services.orchestrator.runtime.sandbox import validate_path
    ...
    def validate_nifti_file(path: str) -> bool:
        ...
        try:
            ...
            raise ValueError(f"Invalid NIfTI file: {e}")
...
class DomainKnowledgeEngine:
    ...
    def get_empirical_advice(self, param_name: str) -> Optional[str]:
...
class DocumentationFetcher:
    ...
    def fetch_python_api(self, package_name: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def fetch_neurodesk_help(self, tool_name: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def fetch_online_docs(self, tool_name: str) -> Optional[Dict[str, Any]]:
        """
        ...
        doc_urls = {
            "fmriprep": "https://fmriprep.org/en/stable/api/",
    ...
    def _extract_param_from_docstring(self, docstring: str, param_name: str) -> Optional[str]:
...
class ParameterDatabase:
    ...
    def get_parameter(self, tool_name: str, param_name: str) -> Optional[Dict[str, Any]]:
    ...
    def get_tool_params(self, tool_name: str) -> Optional[Dict[str, Any]]:
...
class ParameterValidator:
    ...
    def _schema_from_discovery(self, discovery: Dict[str, Any], param_name: str) -> Optional[Dict[str, Any]]:
    ...
    def _convert_api_to_schemas(self, tool_name: str, api_params: Dict) -> List[ParameterSchema]:
        ...
        for func_name, params in api_params.items():
            for param_name, param_info in params.items():
                schema = ParameterSchema(
                    name=param_name,
    ...
    def generate_parameter_help(self, tool_name: str, context: Optional[Dict[str, Any]] = None) -> str:
        """
