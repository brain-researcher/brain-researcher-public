...
class WorkflowComposer:
    ...
    def _infer_data_flow_types(self, tool: NeuroKGToolWrapper) -> Tuple[List[DataFlowType], List[DataFlowType]]:
    ...
    def _get_tool_schema(self, tool: NeuroKGToolWrapper) -> Dict[str, Any]:
