...
from brain_researcher.services.agent.llm_metrics_emitter import emit_llm_metrics
...
from brain_researcher.services.agent.utils.circuit_breaker import CircuitBreaker
...
class LLMRouter:
    ...
    def __init__(
        ...
        *,
        ...
        use_gemini_cli: Optional[bool] = None,
    ...
    def route_chat(
        ...
        **_: Any,
        ...
        if not base_model and task_type != "code":
            base_model = os.environ.get("DEFAULT_LLM_MODEL", DEFAULT_GEMINI_PRIMARY_MODEL)
