...
def _parse_payload_json(raw: Optional[str]) -> Dict[str, Any]:
    if not raw:
        return {}
    try:
...
class AgentJobService:
    ...
    @staticmethod
    def _normalize_project_scope(user_id: Optional[str]) -> str:
        if isinstance(user_id, str) and user_id.strip():
            return user_id.strip()
        return _ANONYMOUS_PROJECT_SCOPE

    @staticmethod
    def _coerce_project_description(description: Optional[str]) -> str:
    ...
    def _default_project(
        self, user_id: Optional[str], now: Optional[int] = None
    ) -> Dict[str, Any]:
    ...
    def _project_to_api_format(
        self, project: Any, user_id: Optional[str]
    ) -> Dict[str, Any]:
    ...
    def list_projects(self, user_id: Optional[str]) -> List[Dict[str, Any]]:
    ...
    def get_project(
        self, user_id: Optional[str], project_id: Optional[str]
    ...
    def project_exists(self, project_id: Optional[str], user_id: Optional[str]) -> bool:
    ...
    def delete_project(self, user_id: Optional[str], project_id: str) -> None:
    ...
    def get_run_bundle(self, run_id: str) -> Optional[Dict[str, Any]]:
        run_record, run_dir = self._load_execution_run_record(run_id)
        if run_record is None or run_dir is None:
            return None
    ...
    def get_async_tool_status(self, run_id: str) -> Optional[Dict[str, Any]]:
    ...
    def get_queue_stats(self) -> Dict[str, Any]:
        ...
        Falls back gracefully if the underlying JobStore lacks the method.
        """
