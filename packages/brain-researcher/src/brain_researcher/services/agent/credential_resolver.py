...
class ResolvedCredential:
    ...
    api_key: Optional[str] = None  # For BYOK and managed credentials
...
class CredentialResolver:
    ...
    def __init__(
        ...
        managed_pool: Optional["ManagedCredentialPool"] = None,
    ):
    ...
    def _configured_byok_credential(self, provider: str) -> Optional[ResolvedCredential]:
    ...
    def _gemini_byok_credential(self) -> Optional[ResolvedCredential]:
    ...
    def _local_gemini_credential(self) -> Optional[ResolvedCredential]:
    ...
    def _resolve_specific(self, credential_name: str) -> Optional[ResolvedCredential]:
    ...
    def resolve_managed_credential(
        self, budget_id: str, model_hint: Optional[str] = None
    ) -> Optional[ResolvedCredential]:
        """
