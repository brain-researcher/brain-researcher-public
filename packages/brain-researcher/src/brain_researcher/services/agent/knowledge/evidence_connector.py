...
class LiteratureConnector:
    ...
    def __init__(self, db=None, use_edirect_fallback: bool = True):
        ...
        try:
            from brain_researcher.services.neurokg.etl.loaders.enhanced_pubmed_loader import (
                EnhancedRateLimiter,
            )
    ...
    async def _search_neo4j(self, query: str, limit: int) -> List[EvidenceItem]:
        ...
        try:
            from brain_researcher.services.neurokg.query_service import search_nodes
...
class ToolCatalogConnector:
    ...
    def __init__(self, registry: Optional["ToolRegistry"] = None):
        ...
        env_flag = os.getenv("NEUROKG_TOOL_DISCOVERY")
