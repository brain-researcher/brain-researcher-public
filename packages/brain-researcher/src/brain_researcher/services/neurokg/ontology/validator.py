...
class OntologyValidator:
    ...
    def validate_domain_range(self, 
                            ontology: nx.DiGraph,
                            properties: Dict[str, Dict[str, Any]]) -> bool:
    ...
    def check_cardinality_constraints(self,
    ...
    def check_orphaned_concepts(self, ontology: nx.DiGraph) -> bool:
        ...
        if not roots:
            self.warnings.append({
                "type": "NO_ROOT",
                "message": "No root concept found in ontology"
            })
            return True
    ...
    def check_unique_uris(self, concepts: Dict[str, Dict[str, Any]]) -> bool:
        ...
        duplicates = {uri: concepts for uri, concepts in uri_to_concepts.items() 
                     if len(concepts) > 1}
    ...
    def validate_ontology(self,
                         ...
                         instances: Optional[Dict[str, Dict[str, Any]]] = None) -> Dict[str, Any]:
        ...
        if properties and instances:
            checks_passed.append(self.check_cardinality_constraints(instances, properties))
        
        # Check for deprecated concepts
        deprecated = [c for c, data in concepts.items() 
