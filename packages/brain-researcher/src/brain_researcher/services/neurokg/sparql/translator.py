...
class SPARQLToCypherTranslator:
    ...
    def __init__(self, base_uri: str = "https://neurokg.org/"):
    ...
    def _extract_order_by(self, parsed_query) -> Optional[str]:
        """Extract ORDER BY clause (not yet implemented)."""
        return None

    def _extract_limit(self, parsed_query) -> Optional[int]:
    ...
    def _extract_offset(self, parsed_query) -> Optional[int]:
