...
if TYPE_CHECKING:
    from brain_researcher.services.orchestrator.evidence_endpoints import EvidenceItem
...
class KnowledgeItem:
    ...
    # Identity
    id: str
    source_id: str  # e.g., "neurokg", "pubmed", "niclip"
    ...
    def to_evidence_item(self) -> "EvidenceItem":
        """Convert to orchestrator's EvidenceItem format."""
        from brain_researcher.services.orchestrator.evidence_endpoints import (
            EvidenceItem,
            EvidenceSource,
            EvidenceType,
            ValidationStatus,
        ...
        source_map = {
            "neurokg": EvidenceSource.NEUROKG,
            ...
            "dataset_catalog": EvidenceSource.DATASET_CATALOG if hasattr(EvidenceSource, "DATASET_CATALOG") else EvidenceSource.NEUROKG,
        }

        # Map to EvidenceType based on source
        type_map = {
            "neurokg": EvidenceType.KG_NODE if hasattr(EvidenceType, "KG_NODE") else EvidenceType.DATASET,
