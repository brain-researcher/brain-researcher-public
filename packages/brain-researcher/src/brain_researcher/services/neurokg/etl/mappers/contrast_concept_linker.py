...
try:
    from brain_researcher.services.neurokg.etl.loaders.ca_task_concept_loader import (
        load_task_concept_weights,
    )
    from brain_researcher.services.neurokg.utils.task_matcher import TaskMatcher
except ImportError:
    # For running as a script from brain_researcher.services.neurokg directory
    sys.path.insert(0, str(Path(__file__).parent.parent))
    from brain_researcher.services.neurokg.etl.loaders.ca_task_concept_loader import load_task_concept_weights
