...
from brain_researcher.services.neurokg.etl.loaders.openneuro_loader.fitlins_loader import OpenNeuroFitLinsLoader
...
def main():
    ...
    # Initialize database
    db_path = "data/neurokg/db/neurokg_integrated.db"
...
if __name__ == "__main__":
    ...
    Path("data/neurokg/db").mkdir(parents=True, exist_ok=True)
