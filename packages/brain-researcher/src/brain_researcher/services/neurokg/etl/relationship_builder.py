...
from brain_researcher.services.neurokg.etl.loaders.neurovault_loader import fetch_neurovault_data
...
class RelationshipBuilder:
    ...
    def __init__(self, db: NeuroKGGraphDB, data_dir: str = "data"):
        """
...
def test_relationship_builder():
    ...
    # Initialize database
    db = NeuroKGGraphDB("test_relationships.db")
