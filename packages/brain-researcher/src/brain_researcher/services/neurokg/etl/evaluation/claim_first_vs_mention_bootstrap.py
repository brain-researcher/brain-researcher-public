...
from brain_researcher.services.neurokg.query_service import verify_hypothesis

logger = logging.getLogger(__name__)

DEFAULT_SAMPLE_PATH = Path("tests/fixtures/neurokg/gabriel_measurements.sample.jsonl")
...
DEFAULT_OUTPUT_DIR = Path("data/neurokg/benchmarks")
DEFAULT_CLAIM_DB = "neurokg_claim_bootstrap_cf"
DEFAULT_CONTROL_DB = "neurokg_claim_bootstrap_ctrl"
