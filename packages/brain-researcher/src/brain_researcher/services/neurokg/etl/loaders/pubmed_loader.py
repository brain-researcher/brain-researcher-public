...
Implements robust rate limiting, batch processing, and error handling.
"""
...
# Cache configuration
CACHE_DIR = Path.home() / ".neurokg_cache" / "pubmed"
...
def _create_robust_session() -> requests.Session:
    ...
    session.headers.update(
        {
            "User-Agent": "BR-KG/1.0 (https://github.com/neurokg/neurokg; contact@neurokg.org)",
            ...
            if year_elem is not None:
                ...
                if month_elem is not None:
                    try:
                        ...
                        date_info["month"] = month_names.get(month_elem.text, 1)
