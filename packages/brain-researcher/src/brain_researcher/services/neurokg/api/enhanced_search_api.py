...
from brain_researcher.services.neurokg.utils.nl_query_parser import NLQueryParser
...
class EnhancedSearchAPI:
    ...
    def __init__(self, db: NeuroKGGraphDB):
        self.db = db
...
def register_enhanced_search_endpoints(app: Flask, db: NeuroKGGraphDB):
