...
DEFAULT_TEMPLATE = os.getenv("BR_NEUROKG_VIZ_DEFAULT_TEMPLATE", "mni152").strip() or "mni152"
DEFAULT_DATASET = os.getenv("BR_NEUROKG_VIZ_DEFAULT_DATASET", "openneuro/ds000114").strip()
...
TEMPLATE_ROOTS = _parse_path_list("BR_NEUROKG_VIZ_TEMPLATE_ROOTS", _DEFAULT_TEMPLATE_ROOTS)
DATASET_ROOTS = _parse_path_list("BR_NEUROKG_VIZ_DATASET_ROOTS", _DEFAULT_DATASET_ROOTS)
JOB_ROOTS = _parse_path_list("BR_NEUROKG_VIZ_JOB_ROOTS", _DEFAULT_JOB_ROOTS)
