...
#### c. `etl/glmfitlins_ingest/load_to_neurokg.py`
...
#### `tests/test_glmfitlins_load_to_neurokg.py`
...
Both `query_neurokg_examples.py` and `query_neurokg_fixed.py` have been updated with examples showing how to query BELONGS_TO relationships:
