...
class VectorSearchConfig:
    ...
    batch_size: int = 32
    cache_dir: str = "data/neurokg/vector_cache"
...
class VectorSearchEngine:
    ...
    def __init__(self, db, config: Optional[VectorSearchConfig] = None):
        ...
        self.index_version = os.environ.get("NEUROKG_VECTOR_INDEX_VERSION", "kg_text_v1")
        self.template_version = os.environ.get("NEUROKG_VECTOR_TEMPLATE_VERSION", "node_text_v1")
    ...
    def _build_indices(self):
        ...
        if os.environ.get("NEUROKG_VECTOR_INCLUDE_REGION", "0").lower() in {"1", "true", "yes", "on"}:
            node_types.append("Region")
        if os.environ.get("NEUROKG_VECTOR_INCLUDE_PUBLICATION", "0").lower() in {"1", "true", "yes", "on"}:
