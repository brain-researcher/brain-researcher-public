...
repo cache under ``data/neurokg/raw/neuromaps``. When no files are present we
...
def resolve_neuromaps_assets(
    ...
    *,
    label_globs: Optional[Iterable[str]] = None,
    template_globs: Optional[Iterable[str]] = None,
) -> NeuromapsAssets:
