...
This module backs ``scripts/neurokg/download_osf_resources.py``. It consumes
...
Download all parcellations into the project cache (requires OSF token)::
    ...
    python scripts/neurokg/download_osf_resources.py \\
        --metadata data/neurokg/raw/neuromaps/datasets/data/osf.json \\
        --section annotations \\
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Directory where downloaded files will be stored (default: data/neurokg/raw/neuromaps).",
    )
    parser.add_argument(
        "--token",
        default=None,
