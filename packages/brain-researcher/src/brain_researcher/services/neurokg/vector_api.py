...
from brain_researcher.services.neurokg.rate_limiting import rate_limit
...
def _vector_search_classes():
    module = importlib.import_module("brain_researcher.services.neurokg.vector_search")
    return module.VectorSearchConfig, module.VectorSearchEngine


def _cache_dir_for(use_niclip: bool) -> str:
    base_dir = Path(os.environ.get("NEUROKG_VECTOR_CACHE_DIR", "data/neurokg/vector_cache"))
