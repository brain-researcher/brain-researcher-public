...
from brain_researcher.services.neurokg.graph.graph_database import NeuroKGGraphDB  # type: ignore
...
def _default_db_factory() -> GraphDatabaseProtocol:
    try:
        ...
        logger.info("Falling back to in-memory NeuroKGGraphDB for VB service")
        return NeuroKGGraphDB(":memory:")
