...
from brain_researcher.services.neurokg.etl.evaluation.gabriel_kggen_eval import (
    evaluate_kggen_coverage,
)
from brain_researcher.services.neurokg.etl.evaluation.gabriel_onvoc_map import (
    map_kggen_to_onvoc,
)
from brain_researcher.services.neurokg.etl.gabriel_generator import (
    DEFAULT_CACHE_DIR,
    DEFAULT_OUTPUT_ROOT,
...
def eval_kggen(
    ...
    output_dir: Path = typer.Option(
        Path("data/neurokg/raw/gabriel/eval/kggen"),
        "--output-dir",
...
def map_onvoc(
    ...
    output_dir: Path = typer.Option(
        Path("data/neurokg/raw/gabriel/eval/kggen/onvoc"),
        "--output-dir",
