...
from brain_researcher.services.neurokg.etl.loaders.scientific_review_rule_registry_loader import (
...
from brain_researcher.services.neurokg.loader import tools_catalog_loader
from brain_researcher.services.neurokg.spatial.overlay_statmaps_yeo17 import (
...
# Alias for nested grouping: br neurokg ingest <cmd>
neurokg_app = typer.Typer(help="BR-KG commands")
neurokg_app.add_typer(app, name="ingest")
...
def tools_catalog(
    ...
    evidence: Path = typer.Option(
        Path("configs/neurokg/tool_evidence.yaml"), exists=False, readable=True
    ),
...
@neurokg_app.command("overlay-yeo17")
