...
if not _skip_heavy:
    ...
    app.add_typer(neurokg_ingest.app, name="neurokg-ingest", help="BR-KG ingestion commands")
    app.add_typer(neurokg_ingest.neurokg_app, name="neurokg", help="BR-KG graph commands")
