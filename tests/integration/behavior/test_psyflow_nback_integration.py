"""Integration stub: generate n-back scaffold and run psyflow-validate.

Skips automatically when the ``behavior-task`` extra (psyflow) is not
installed.
"""
...
def test_nback_scaffold_validates(tmp_path: Path):
