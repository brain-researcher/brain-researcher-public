...
def test_niclip_vs_sentence_transformer():
    ...
    for query in queries:
        ...
        response = requests.post(
            ...
            json={"query": query, "k": 3, "use_niclip": False},
        )
        ...
        response = requests.post(
            f"{BASE_URL}/vector/search",
            json={"query": query, "k": 3, "use_niclip": True},
        )
...
def test_embedding_generation():
    ...
    response = requests.post(
        f"{BASE_URL}/vector/embedding", json={"text": test_text, "use_niclip": False}
    )
    ...
    response = requests.post(
        f"{BASE_URL}/vector/embedding", json={"text": test_text, "use_niclip": True}
    )
