...
class TestFullSystemIntegration:
    ...
    def test_data_persistence(self):
        ...
        session_data = {
            ...
            'api_keys': [
                {'id': 'key_1', 'permissions': ['read', 'write']}
            ]
        }
    ...
    async def test_dataset_integration_flow(self):
        ...
        search_results = {
            'datasets': [
                {'id': 'ds000114', 'name': 'Motor Task', 'n_subjects': 10}
            ],
            'total': 1
        }
    ...
    def test_notification_system(self):
        ...
        high_priority = [n for n in notifications if n['priority'] in ['high', 'critical']]
...
class TestAPIIntegration:
    ...
    def test_orchestrator_endpoints(self):
        ...
        endpoint_groups = {
            ...
            'datasets': ['/api/datasets', '/api/datasets/{id}', '/api/datasets/{id}/preview'],
            'visualization': ['/api/knowledge-graph', '/api/pipeline/{id}', '/api/gallery'],
            'settings': ['/api/settings/profile', '/api/settings/preferences', '/api/settings/api-keys'],
    ...
    def test_service_health_checks(self):
        ...
        services = {
            ...
            'neurokg': 'http://localhost:5000/health',
