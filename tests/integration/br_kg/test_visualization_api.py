...
from brain_researcher.services.br_kg.api.visualization import router
...
class TestVisualizationAPI:
    ...
    def test_prepare_visualization_with_filters(self, client):
        ...
        request_data = {
            ...
            "filters": {"min_degree": 2, "max_degree": 10},
        }
    ...
    def test_invalid_layout_algorithm(self, client):
        ...
        request_data = {"layout_algorithm": "invalid_layout"}
    ...
    def test_performance_constraint(self, client):
        ...
        request_data = {"layout_algorithm": "force_directed", "max_nodes": 1000}
