...
class MockDataGenerator:
    ...
    def job_details(
        ...
        job = {
            ...
            "timing": {
                ...
                "end_time": MockDataGenerator.iso_datetime() if status == "completed" else None,
    ...
    def thread_create_request(title: str = "Analysis Thread") -> Dict[str, Any]:
        ...
        return {
            ...
            "metadata": {
                "created_by": MockDataGenerator.user_id("demo_user")
            }
        }
    
    @staticmethod
    def thread_response(thread_id: str = None, title: str = "Analysis Thread") -> Dict[str, Any]:
    ...
    def dataset_list(count: int = 5) -> Dict[str, Any]:
        ...
        for i in range(count):
            datasets.append({
                ...
                "last_updated": MockDataGenerator.iso_datetime(-fake.random_int(1, 365) * 1440)
            })
    ...
    def health_response(
        ...
        services = services or ["agent", "neurokg"]
        service_health = {}
    ...
    def notification_list(count: int = 3) -> Dict[str, Any]:
        ...
        for i in range(count):
            notifications.append({
                ...
                "user_id": MockDataGenerator.user_id("demo_user"),
                "type": fake.random_element(["job_complete", "job_failed", "system_alert"]),
                "priority": fake.random_element(["low", "normal", "high"]),
                "title": fake.sentence(4),
                "message": fake.text(100),
                "data": {},
                "read": fake.boolean(),
                "created_at": MockDataGenerator.iso_datetime(-fake.random_int(1, 1440)),
                "read_at": MockDataGenerator.iso_datetime() if fake.boolean() else None
            })
