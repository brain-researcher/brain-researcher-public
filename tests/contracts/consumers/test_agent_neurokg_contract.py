...
try:
    ...
    pytest.skip("pact Consumer/Provider not available (pact-python v3?); skipping contract tests", allow_module_level=True)
...
class TestAgentToNeuroKGContract:
    ...
    def pact_client(self):
        ...
        return PactClient(agent_config, neurokg_config)
    ...
    async def test_analysis_context_contract(self, pact_client):
        ...
        async with pact_client as pact:
            ...
            (pact
             .given("dataset exists with analysis context")
    ...
    async def test_literature_lookup_contract(self, pact_client):
        ...
        async with pact_client as pact:
            ...
            (pact
             .given("knowledge graph has literature")
    ...
    async def test_prior_analysis_lookup_contract(self, pact_client):
        ...
        async with pact_client as pact:
            (pact
             .given("dataset has prior analyses")
            ...
            # Execute the request
            response = await pact.execute_request(
                "GET", f"/api/datasets/{dataset_id}/analyses",
    ...
    async def test_knowledge_graph_unavailable_contract(self, pact_client):
        ...
        async with pact_client as pact:
            ...
            (pact
             .given("knowledge graph is temporarily unavailable")
    ...
    async def test_bulk_concept_lookup_contract(self, pact_client):
        ...
        async with pact_client as pact:
            ...
            # Execute the request
            response = await pact.execute_request(
                "POST", "/api/coordinates/bulk-lookup",
                headers={"Content-Type": "application/json"},
