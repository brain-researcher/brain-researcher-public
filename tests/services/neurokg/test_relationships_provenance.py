...
from brain_researcher.services.neurokg.gql_schema.relationships import (
    ProvenanceSource,
    RelationshipType,
)
...
class TestRelationshipTypes:
    ...
    def test_relationship_types_enum(self):
        ...
        expected_types = [
            "MEASURES", "ACTIVATES", "DERIVED_FROM", "RELATED_TO",
            "PART_OF", "SUBCLASS_OF", "CITES", "CITED_BY",
            "COACTIVATES_WITH", "SIMILAR_TO", "CONTRASTS_WITH",
            "USES_TASK", "IN_REGION", "HAS_COORDINATE"
        ]
    ...
    def test_provenance_sources_enum(self):
        ...
        expected_sources = [
            "PUBMED", "OPENNEURO", "NEUROVAULT", "COGATLAS",
            "MANUAL_CURATION", "AUTOMATED_EXTRACTION",
            "MODEL_PREDICTION", "USER_SUBMISSION"
        ]
...
class TestRelationshipValidation:
    ...
    def test_valid_relationships(self):
        ...
        from brain_researcher.services.neurokg.bulk_loader import EntityValidator
...
class TestRelationshipQueries:
    ...
    def setup_with_relationships(self, tmp_path, monkeypatch):
        ...
        relationships = [
            ("memory", "nback", "MEASURES", {
                "confidence": 0.9,
                "source": "CogAtlas",
                "method": "assertion",
                "timestamp": datetime.now().isoformat()
            }),
            ("attention", "stroop", "MEASURES", {
                "confidence": 0.85,
                "source": "CogAtlas",
                "method": "assertion",
                "timestamp": datetime.now().isoformat()
            ...
            ("stroop", "acc", "ACTIVATES", {
                "confidence": 0.75,
                "source": "PubMed",
                "source_id": "87654321",
                "timestamp": datetime.now().isoformat()
            }),
            ("memory", "attention", "RELATED_TO", {
                "confidence": 0.7,
                "source": "Manual",
                "timestamp": datetime.now().isoformat()
            })
