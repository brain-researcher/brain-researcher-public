...
class TestGraphQLSchema:
    ...
    def setup(self, tmp_path, monkeypatch):
        ...
        self.db.create_node("Region", {"id": "test_region", "name": "Test Region", "abbreviation": "TR"})
    ...
    def test_query_publications(self):
        ...
        self.db.create_node("Publication", {
            "id": "test_pub",
            "pmid": "12345678",
    ...
    def test_empty_database_queries(self):
        ...
        assert result.data["concepts"] == [] or isinstance(result.data["concepts"], list)
