...
from brain_researcher.services.neurokg.migrations import (
    Migration,
    MigrationRunner,
    MigrationManager,
    MigrationRecord
...
class TestMigrationRunner:
    ...
    def test_rollback_migration(self, runner, temp_db):
        ...
        assert all(m.version != "test_001" or m.status == "rolled_back" 
                  for m in applied)
...
""")
        ...
        assert [m.version for m in manager.migrations] == ["000_test", "001_test", "002_test"]
...
class TestRealMigrations:
    ...
    def test_initial_schema_migration(self, temp_db):
        ...
        migration_path = Path(__file__).parent.parent.parent.parent / "brain_researcher/services/neurokg/migrations/migrations/001_initial_schema.py"
