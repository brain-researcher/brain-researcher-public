...
class JWTSecurityChecker:
    ...
    def _check_line_for_issues(self, line: str, line_num: int, file_path: Path, issues: List[Dict]):
            ...
            for pattern in patterns:
                ...
                if match:
                    ...
                    if issue_type in ['no_algorithm_verification', 'missing_audience']:
                        if any(re.search(good_pattern, line, re.IGNORECASE)
    ...
    def _check_jwt_encode_expiration(self, content: str, file_path: Path, issues: List[Dict]):
    ...
    def _is_weak_secret(self, secret: str) -> bool:
        ...
        # Common weak secrets
        weak_secrets = {
            'secret', 'password', 'key', 'test', 'admin', 'demo',
            '123456', 'abc123', 'password123', 'secret123',
            'qwerty', 'admin123', 'test123'
        }
    ...
    def _get_severity(self, issue_type: str) -> str:
        ...
        high_severity = {
            'weak_secret', 'algorithm_none', 'no_algorithm_verification',
            'missing_expiration', 'hardcoded_tokens'
        }
        medium_severity = {
            'insecure_storage', 'token_in_logs', 'missing_audience'
        }
    ...
    def _get_recommendation(self, issue_type: str) -> str:
        ...
        return recommendations.get(issue_type, 'Review JWT implementation for security best practices')
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Check JWT implementation security'
    )
    ...
    if args.json:
        ...
        print(f"JWT Security Check Results:")
