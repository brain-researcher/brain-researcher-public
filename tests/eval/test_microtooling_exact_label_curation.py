...
def _patch_catalog(monkeypatch: Any) -> None:
    catalog = {
        ...
        "consult_knowledge_graph": SimpleNamespace(name="Consult Knowledge Graph", capabilities=["neurokg"], intents=[]),
        "find_related_concepts": SimpleNamespace(name="Find Related Concepts", capabilities=["neurokg"], intents=[]),
        ...
        "neurokg.search_nodes": SimpleNamespace(name="Search Nodes", capabilities=["search"], intents=[]),
        "neurokg_find_related_concepts": SimpleNamespace(name="Related Concepts", capabilities=["neurokg"], intents=[]),
        "neurokg_graph_query": SimpleNamespace(name="NeuroKG Graph Query", capabilities=["neurokg"], intents=[]),
