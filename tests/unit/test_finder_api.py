...
from brain_researcher.services.neurokg import finder_api as finder_module
from brain_researcher.services.neurokg.finder_api import (
    DatasetSearcher,
    FacetCounter,
    Filter,
    NLPFilterParser,
...
class TestFinderAPIIntegration:
    ...
    @patch('brain_researcher.services.neurokg.finder_api.Neo4jConnection')
