...
def _legacy_service_script_path(script_name: str) -> str:
    return "/services/neurokg" + "/scripts/" + script_name
...
REQUIRED_SUBSTRINGS = {
    ...
    "docs/services/neurokg/kg_tool_schema.md": (
        "src/brain_researcher/services/neurokg/loader/tools_catalog_loader.py",
        "src/brain_researcher/cli/commands/neurokg_ingest.py",
    ),
    ...
    "scripts/dev/update_requirements_for_graph_viz.py": (
        "src/brain_researcher/services/neurokg/requirements.txt",
    ),
    "docs/getting-started/configuration.md": ("# src/brain_researcher/config/",),
    "docs/standards/invariants.md": (
        "src/brain_researcher/services/neurokg/graph/neo4j_graph_database.py:79-84",
    ),
    "docs/standards/MATCHING_IMPLEMENTATION.md": (
        "src/brain_researcher/services/neurokg/matching/node_matcher.py",
    ),
    ...
    "docs/standards/README.md": (
        "src/brain_researcher/services/neurokg/schemas/",
        "src/brain_researcher/services/neurokg/mappings/",
    ...
    "docs/PRD/prd_o2_kg_service.md": (
        "src/brain_researcher/services/neurokg/models/niclip.py",
    ...
    "docs/PRD/prd_o3_model_architecture.md": (
        ...
        "src/brain_researcher/services/neurokg/models/fmri_text_alignment.py",
        "src/brain_researcher/services/tools/neurokg_tools.py",
        "from brain_researcher.services.neurokg.models.niclip import NiCLIPModel",
    ),
    "docs/neurokg/NICLIP_COMPLETE_INTEGRATION.md": (
        "src/brain_researcher/services/tools/neurokg_tools.py",
        "src/brain_researcher/services/neurokg/etl/strength_calculator.py",
        "src/brain_researcher/services/neurokg/etl/mappers/cross_source_linker.py",
        "src/brain_researcher/services/neurokg/etl/mappers/niclip_spatial_mapper.py",
        "src/brain_researcher/services/neurokg/etl/mappers/niclip_concept_hierarchy.py",
    ),
    ...
    "docs/archive/cli_migration_guide.md": (
        "scripts/neurokg/init_database.py",
        "scripts/neurokg/optimize_db.py",
        "scripts/neurokg/merge_databases.py",
    ),
    "docs/services/neurokg/node_label_linker_integration.md": (
        "/scripts/neurokg/link_duplicate_nodes.py",
        "/scripts/neurokg/init_database.py",
        "/scripts/neurokg/load_glmfitlins_to_kg.py",
        "/scripts/neurokg/load_openneuro_fitlins.py",
        "/scripts/neurokg/scheduled_cross_linker.py",
        "/scripts/neurokg/setup_cron_linker.sh",
        "/scripts/neurokg/ttl_edge_cleanup.py",
        "/scripts/neurokg/setup_cron_ttl_cleanup.sh",
    ),
    "docs/services/neurokg/EDGE_INTEGRATION_SUMMARY.md": (
        "scripts/neurokg/integrate_coordinate_relationships.py",
        "scripts/neurokg/integrate_study_concept_relationships.py",
        "scripts/neurokg/integrate_ontology_relationships.py",
        "scripts/neurokg/integrate_statistical_maps.py",
        "scripts/neurokg/integrate_subject_relationships.py",
        "scripts/neurokg/init_database.py",
    ),
    ...
    "docs/neurokg/SPATIAL_SEMANTIC_MAPPING_GUIDE.md": (
        "scripts/neurokg/create_in_region_edges.py",
        "src/brain_researcher/services/neurokg/spatial/create_in_region_edges.py",
        "src/brain_researcher/services/neurokg/etl/loaders/niclip_loader.py",
        "scripts/neurokg/calculate_strength.py",
        "src/brain_researcher/services/neurokg/scoring/calculate_strength.py",
        "tests/integration/mappers/test_spatial_semantic_mapping.py",
        "cd /path/to/brain_researcher",
        "src/brain_researcher/services/neurokg/etl/loaders/",
        "scripts/neurokg/",
        "src/brain_researcher/services/neurokg/spatial/",
    ...
    "scripts/services/neurokg/start_api_correct.sh": (
        'REPO_ROOT=$(cd -- "$SCRIPT_DIR/../../.." && pwd)',
        'export PYTHONPATH="$REPO_ROOT/src${PYTHONPATH:+:$PYTHONPATH}"',
        "python -m brain_researcher.services.neurokg.api.graph_api",
    ),
    "scripts/services/neurokg/restart_api.sh": (
        'REPO_ROOT=$(cd -- "$SCRIPT_DIR/../../.." && pwd)',
        'export PYTHONPATH="$REPO_ROOT/src${PYTHONPATH:+:$PYTHONPATH}"',
        "python -m brain_researcher.services.neurokg.api.graph_api",
    ),
    "scripts/root_legacy/check_env.py": (
        ...
        '"BR-KG .env": "src/brain_researcher/services/neurokg/.env"',
        'print("  br serve web     # Next.js Web UI")',
    ),
    "docs/specs/dataset_task_unmatched_report.md": (
        "python scripts/neurokg/create_dataset_task_relationships.py",
        "python scripts/neurokg/build_dataset_task_review_pack.py",
        "python scripts/neurokg/build_dataset_task_decision_pack.py",
    ),
...
FORBIDDEN_SUBSTRINGS = {
    ...
    "docs/services/neurokg/kg_tool_schema.md": (
        "`brain_researcher/services/neurokg/loader/tools_catalog_loader.py`",
        "`brain_researcher/cli/commands/neurokg_ingest.py`",
    ),
    "scripts/ci/generate_resources_schema.py": (
        "`brain_researcher/services/shared/planner/models.py`",
    ),
    ...
    "scripts/dev/update_requirements_for_graph_viz.py": (
        "pip install -r services/neurokg/requirements.txt",
    ),
    "docs/getting-started/configuration.md": ("# brain_researcher/config.py",),
    "docs/standards/invariants.md": (
        "`brain_researcher/services/neurokg/graph/neo4j_graph_database.py:79-84`",
    ),
    "docs/standards/MATCHING_IMPLEMENTATION.md": (
        "**`brain_researcher/services/neurokg/matching/node_matcher.py`**",
    ),
    "docs/archive/TOOL_DISCOVERY_ENHANCEMENT_PLAN.md": (
    ...
    "docs/standards/README.md": (
        "`brain_researcher/services/neurokg/schemas/`",
        "`brain_researcher/services/neurokg/mappings/`",
    ...
    "docs/neurokg/NICLIP_COMPLETE_INTEGRATION.md": (
        "`brain_researcher/services/agent/tools/neurokg_tools.py`",
        "`brain_researcher/services/neurokg/etl/strength_calculator.py`",
        "`brain_researcher/services/neurokg/etl/mappers/cross_source_linker.py`",
        "`brain_researcher/services/neurokg/etl/mappers/niclip_spatial_mapper.py`",
        "`brain_researcher/services/neurokg/etl/mappers/niclip_concept_hierarchy.py`",
    ),
    "docs/archive/TODO.md": (
    ...
    "scripts/tools/ontologies/build_onvoc_mapping_rules.py": (
        'fallback=Path("brain_researcher/services/neurokg/mappings/onvoc_crosswalk.yaml")',
    ),
    "docs/architecture/H7_H8_cross_modal_glue.md": (
    ...
    "docs/neurokg/SPATIAL_SEMANTIC_MAPPING_GUIDE.md": (
        "src/brain_researcher/services/neurokg/scripts/create_in_region_edges.py",
        "`brain_researcher/services/neurokg/scripts/create_in_region_edges.py`",
        "`brain_researcher/services/neurokg/etl/strength_calculator.py`",
        "python -m brain_researcher.services.neurokg.scripts.create_in_region_edges",
        ...
        "- Utility scripts in `src/brain_researcher/services/neurokg/scripts/`",
    ...
    "scripts/services/neurokg/start_api_correct.sh": (
        "/data/ECoG-foundation-model/mnndl_temp/brain_researcher/services/neurokg",
    ...
    "scripts/root_legacy/check_env.py": (
        ...
        '"BR-KG .env": "brain_researcher/services/neurokg/.env"',
        'print("  br serve ui      # Dashboard")',
    ),
    "docs/specs/dataset_task_unmatched_report.md": (
        "python brain_researcher/services/neurokg/scripts/create_dataset_task_relationships.py \\",
        "python brain_researcher/services/neurokg/scripts/build_dataset_task_review_pack.py \\",
        "python brain_researcher/services/neurokg/scripts/build_dataset_task_decision_pack.py",
    ),
    "docs/planning/resume_rebuild_runbook.md": (
        "python -m brain_researcher.services.neurokg.scripts.materialize_brainregion_hierarchy",
    ),
    "src/brain_researcher/services/tools/niwrap/boutiques.py": (
