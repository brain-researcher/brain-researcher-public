...
from brain_researcher.services.orchestrator import taskbeacon_handoff as old_handoff
from brain_researcher.services.orchestrator import taskbeacon_mcp_adapter as old_adapter
...
def test_orchestrator_taskbeacon_handoff_reexports_tools_helpers() -> None:
    ...
    assert (
        old_handoff.normalize_taskbeacon_repo is new_handoff.normalize_taskbeacon_repo
    )
    assert (
        old_handoff.materialize_taskbeacon_repo
        is new_handoff.materialize_taskbeacon_repo
    )
