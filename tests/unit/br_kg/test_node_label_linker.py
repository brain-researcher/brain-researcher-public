...
def patch_sentence_transformer():
    ...
    linker_target = "brain_researcher.services.br_kg.utils.node_label_linker"
...
class TestNodeLabelLinker(unittest.TestCase):
    ...
    def test_fuzzy_matching_fallback(self):
        ...
        with patch(
            "brain_researcher.services.br_kg.utils.node_label_linker.EMBEDDINGS_AVAILABLE",
            False,
        ):
            linker = NodeLabelLinker(self.db)
    ...
    def test_faiss_indexing(self):
        ...
        with patch_sentence_transformer() as mock_model:
            ...
            with patch(
                "brain_researcher.services.br_kg.utils.node_label_linker.faiss"
            ) as mock_faiss:
                # Mock FAISS index
                mock_index = Mock()
    ...
    def test_build_faiss_index_uses_gpu_when_available(self, _mock_alias_map):
        ...
        module_path = "brain_researcher.services.br_kg.utils.node_label_linker"
