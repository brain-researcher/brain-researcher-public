...
class TestSPARQLEndpoint:
    ...
    def sparql_endpoint(self, mock_neo4j_db):
        ...
        with patch('brain_researcher.services.br_kg.sparql.endpoint.SPARQLToCypherTranslator'):
            with patch('brain_researcher.services.br_kg.sparql.endpoint.FederationQueryHandler'):
    ...
    def test_endpoint_initialization(self, mock_neo4j_db):
        ...
        with patch('brain_researcher.services.br_kg.sparql.endpoint.SPARQLToCypherTranslator') as mock_translator:
            with patch('brain_researcher.services.br_kg.sparql.endpoint.FederationQueryHandler') as mock_federation:
                endpoint = SPARQLEndpoint(
                    neo4j_db=mock_neo4j_db,
    ...
    def test_query_caching(self, sparql_endpoint):
        ...
        with patch('brain_researcher.services.br_kg.sparql.endpoint.parseQuery') as mock_parse:
