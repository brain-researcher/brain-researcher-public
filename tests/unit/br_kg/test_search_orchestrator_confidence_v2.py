...
from brain_researcher.services.br_kg.search.orchestrator import SearchOrchestrator
...
def test_search_orchestrator_v2_penalizes_conflict_and_uncertainty(monkeypatch):
    ...
    monkeypatch.setattr(
        "brain_researcher.services.br_kg.search.orchestrator.query_service.search_nodes",
    ...
    monkeypatch.setattr(
        "brain_researcher.services.br_kg.search.orchestrator.search_gfs_auto",
        lambda *args, **kwargs: {
            "status": "ok",
            "hits": support_hits,
            "store": "dummy",
