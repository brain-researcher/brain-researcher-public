...
@pytest.fixture
def mock_br_kg_connector(sample_evidence_items):
    """Create a mock BR-KG connector."""
    items = [i for i in sample_evidence_items if i.source == EvidenceSource.BR_KG]
    return MockConnector(EvidenceSource.BR_KG, items)
