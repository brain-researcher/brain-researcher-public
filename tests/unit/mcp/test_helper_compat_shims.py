...
def test_mcp_param_norm_compat_shim_reexports_shared_helpers() -> None:
    ...
    assert (
        mcp_param_norm.resolve_enum_or_error is shared_param_norm.resolve_enum_or_error
    )
...
def test_mcp_loop_primitives_compat_shim_reexports_shared_helpers() -> None:
    ...
    assert (
        mcp_loop_primitives.get_loop_profile is shared_loop_primitives.get_loop_profile
    )
    assert (
    ...
    assert (
        mcp_loop_primitives.build_run_scorecard
        is shared_loop_primitives.build_run_scorecard
    )
    assert (
