...
class TestKafkaProducer:
    ...
    async def test_import_error_handling(self):
        ...
        with patch('brain_researcher.services.neurokg.streaming.kafka_integration.AIOKafkaProducer', None):
            config = StreamConfig()
...
class TestKafkaConsumer:
    ...
    def kafka_consumer(self, stream_config):
        ...
        with patch('brain_researcher.services.neurokg.streaming.kafka_integration.AIOKafkaConsumer'):
...
async def test_end_to_end_messaging():
    ...
    with patch('brain_researcher.services.neurokg.streaming.kafka_integration.AIOKafkaProducer'):
        with patch('brain_researcher.services.neurokg.streaming.kafka_integration.AIOKafkaConsumer'):
