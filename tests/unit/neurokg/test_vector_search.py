...
class TestVectorSearchEngine:
    ...
    @patch('brain_researcher.services.neurokg.vector_search.SentenceTransformer')
    ...
    @patch('brain_researcher.services.neurokg.vector_search.SentenceTransformer')
    @patch('brain_researcher.services.neurokg.search.SearchEngine')
    def test_hybrid_search(self, mock_search_engine, mock_st):
        ...
        from brain_researcher.services.neurokg.search import SearchResult
        mock_text_results = [
            SearchResult(
                node_id="node1",
                node_type="Concept",
