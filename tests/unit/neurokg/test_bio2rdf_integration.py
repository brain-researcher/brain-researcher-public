...
from brain_researcher.services.neurokg.bio2rdf import (
    Bio2RDFClient,
    OntologyMapper,
...
class TestBio2RDFClient:
    ...
    @patch('brain_researcher.services.neurokg.bio2rdf.bio2rdf_client.SPARQLWrapper')
...
class TestOntologyMapper:
    ...
    def test_exact_mapping(self, mapper):
        ...
        assert mappings[0].neurokg_label == 'hippocampus'
    ...
    def test_generate_mapping_sparql(self, mapper):
        ...
        mappings = [
            ConceptMapping(
                neurokg_id='neurokg:hippocampus',
                neurokg_label='hippocampus',
                neurokg_type='brain_region',
        ...
        assert 'neurokg:hippocampus' in sparql
...
class TestLinkEnrichmentEngine:
    ...
    def test_enrich_brain_region(self, engine):
        ...
        assert enriched.entity_id == 'neurokg:hippocampus'
    ...
    def test_enrich_cognitive_task(self, engine):
        ...
        engine.ontology_mapper.map_concept.return_value = [
            ConceptMapping(
                neurokg_id='neurokg:working_memory',
                neurokg_label='working_memory',
                neurokg_type='cognitive_task',
    ...
    def test_batch_enrichment(self, engine):
        ...
        entities = [
            ('neurokg:hippocampus', 'brain_region', 'hippocampus'),
            ('neurokg:dopamine', 'neurochemical', 'dopamine')
        ]
    ...
    def test_export_enrichment_graph_json(self, engine):
        ...
        assert data['@graph'][0]['@id'] == 'neurokg:hippocampus'
