...
class TestGLMFitLinsLoadToNeuroKG(unittest.TestCase):
    def setUp(self):
    ...
    def test_load_creates_belongs_to_relationships(self):
        """Test that load_to_neurokg creates BELONGS_TO relationships"""
        # Import here to avoid circular imports
        from brain_researcher.services.neurokg.etl.glmfitlins_ingest.load_to_neurokg import (
            load_to_neurokg,
        )
        ...
        db = NeuroKGGraphDB(str(self.db_path))
