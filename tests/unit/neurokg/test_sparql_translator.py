...
class TestSPARQLToCypherTranslator:
    ...
    def translator(self):
        ...
        return SPARQLToCypherTranslator(base_uri="https://test.neurokg.org/")
    ...
    def test_uri_to_node_id_base_uri(self, translator):
        ...
        uri = "https://test.neurokg.org/concept123"
    ...
    def test_translate_triple_pattern_uri_subject_object(self, translator):
        ...
        pattern = (
            "https://test.neurokg.org/subject1",
            "http://example.org/relatedTo", 
            "https://test.neurokg.org/object1"
        )
...
class TestSPARQLTranslatorQueryTranslation:
    ...
    @patch('brain_researcher.services.neurokg.sparql.translator.parseQuery')
...
class TestSPARQLTranslatorComplexScenarios:
    ...
    def test_multiple_triple_patterns(self, translator):
        ...
        patterns = [
            ...
            ('?subject', 'http://neurokg.org/hasProperty', '?property'),
            ('?property', 'http://neurokg.org/hasValue', '"some_value"')
        ]
    ...
    def test_nested_uri_structure(self, translator):
        ...
        complex_uri = "https://neurokg.org/brain/regions/cortical/frontal/prefrontal"
    ...
    def test_international_characters(self, translator):
        ...
        uri_with_unicode = "https://neurokg.org/región-cerebral"
    ...
    def test_very_long_uris(self, translator):
        ...
        long_uri = "https://neurokg.org/" + "very_long_path/" * 50 + "final_resource"
