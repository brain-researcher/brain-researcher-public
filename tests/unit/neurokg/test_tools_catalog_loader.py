...
from brain_researcher.services.neurokg.loader import tools_catalog_loader as loader
...
def test_ibl_public_config_surfaces_use_canonical_ids():
    ...
    for relpath in (
        ...
        "configs/neurokg/tool_evidence.yaml",
    ):
    ...
    tool_evidence = Path("configs/neurokg/tool_evidence.yaml").read_text()
