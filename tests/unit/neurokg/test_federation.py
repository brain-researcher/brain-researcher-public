...
from brain_researcher.services.neurokg.federation.wikidata import WikidataConnector
...
class TestWikidataConnector:
    ...
    @patch('brain_researcher.services.neurokg.federation.wikidata.SPARQLWrapper')
    ...
    @patch('brain_researcher.services.neurokg.federation.wikidata.WikidataConnector._execute_query')
