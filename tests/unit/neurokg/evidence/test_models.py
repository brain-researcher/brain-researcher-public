...
class TestEvidenceItem:
    ...
    def test_create_basic_item(self):
        ...
        assert item.source == EvidenceSource.NEUROKG
...
class TestEvidenceBundle:
    ...
    def test_filter_by_source(self, sample_evidence_items):
        ...
        bundle = EvidenceBundle(query="test", items=sample_evidence_items)
        filtered = bundle.filter_by_source(EvidenceSource.NEUROKG)

        assert len(filtered) == 1
        assert all(i.source == EvidenceSource.NEUROKG for i in filtered)
    ...
    def test_summary(self, sample_evidence_items):
        ...
        bundle = EvidenceBundle(
            query="test",
            items=sample_evidence_items,
            sources_queried=[EvidenceSource.NEUROKG, EvidenceSource.DATASET_CATALOG],
            query_time_ms=150.5,
        )
        ...
        assert "neurokg" in summary["sources_queried"]
...
class TestEvidenceSource:
    ...
    def test_source_values(self):
        ...
        assert EvidenceSource.NEUROKG.value == "neurokg"
