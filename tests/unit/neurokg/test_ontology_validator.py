...
from brain_researcher.services.neurokg.ontology.validator import OntologyValidator
...
class TestOntologyValidator:
    ...
    def test_cardinality_constraints(self, validator):
        ...
        properties = {
            'hasOwner': {
                'min_cardinality': 1,
                'max_cardinality': 2  # Max 2 owners
            }
        }
