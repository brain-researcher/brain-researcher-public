...
class TestVectorSearchEngine:
    ...
    def engine(self):
        ...
        with patch('brain_researcher.services.br_kg.search.vector_search.TRANSFORMERS_AVAILABLE', False):
...
class TestPineconeIntegration:
    ...
    @patch('brain_researcher.services.br_kg.search.vector_search.PINECONE_AVAILABLE', True)
    ...
    def test_pinecone_store_creation(self, mock_pinecone):
        ...
        from brain_researcher.services.br_kg.search.vector_search import PineconeVectorStore
