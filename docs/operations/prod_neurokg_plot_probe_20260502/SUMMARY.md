# Prod NeuroKG Plot Probe

Generated from bounded prod queries through `brain-researcher-vm` and `brain-researcher-neurokg-0`.
...
- `figures/fig10_neurokg_3d_schema_browser.html`: interactive Neo4j/Bloom-style 3D schema graph browser.
- `figures/fig10_neurokg_3d_schema_browser_desktop.png`: desktop preview of the interactive schema graph.
- `figures/fig10_neurokg_3d_schema_browser_mobile.png`: mobile preview of the interactive schema graph.
...
- `tables/neurokg_schema_inventory.html`: searchable comprehensive schema inventory tables.
- `tables/neurokg_schema_triples_comprehensive.csv`: main source/relationship/target schema-triple table.
...
- Interpretation: NeuroKG is not a homogeneous graph; its largest surfaces are source-specific schema blocks such as map membership, publication terms/coordinates, and StatsMap spatial/model relations.
...
- Browser artifact: `figures/fig10_neurokg_3d_schema_browser.html`.
- Graph data: `data/fig10_neurokg_3d_schema_graph_data.json`.
...
- Searchable table browser: `tables/neurokg_schema_inventory.html`.
- Main supplement-style table: `tables/neurokg_schema_triples_comprehensive.csv`.
- Supporting tables: `tables/neurokg_labelset_nodes_inventory.csv`, `tables/neurokg_node_labels_inventory.csv`, `tables/neurokg_relationship_types_inventory.csv`, and `tables/neurokg_source_target_surfaces.csv`.
- Data dictionary: `tables/neurokg_schema_inventory_data_dictionary.md`.
...
- Overview data: `data/neurokg_overview_panel_data.json`.
- Source/provenance probe: `data/neurokg_source_values_probe.json`.
