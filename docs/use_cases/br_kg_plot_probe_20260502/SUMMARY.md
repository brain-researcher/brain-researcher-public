...
- `figures/fig10_br-kg_3d_schema_browser.html`: interactive Neo4j/Bloom-style 3D schema graph browser.
- `figures/fig10_br-kg_3d_schema_browser_desktop.png`: desktop preview of the interactive schema graph.
- `figures/fig10_br-kg_3d_schema_browser_mobile.png`: mobile preview of the interactive schema graph.
...
- `tables/br-kg_schema_inventory_data_dictionary.md`: table dictionary and generation notes.
...
- Raw heatmap table: generated locally and not committed in this public docs tree.
...
- Raw atlas metrics and schema CSV/JSON exports: generated locally and not committed in this public docs tree.
...
- Browser artifact: `figures/fig10_br-kg_3d_schema_browser.html`.
- Graph data: embedded in the retained browser artifact; raw JSON export is not committed.
...
- Main supplement-style table: retained inside `tables/br-kg_schema_inventory.html`.
- Supporting CSV/JSON tables: generated locally and intentionally not committed.
...
- Overview and source/provenance probe data: generated locally and intentionally not committed.
...
- Individual example figures: `figures/fig16a_brkg_literature_peak.png` through `figures/fig16f_brkg_tool_contract.png`.
- Multi-hop path figure: `figures/fig17_brkg_multihop_query_path.png`.
- Example and source-probe JSON exports: generated locally and intentionally not committed.
...
- Full task-pair table: generated locally and intentionally not committed.
...
- Episode-state table: generated locally and intentionally not committed.
...
- Feature table: generated locally and intentionally not committed.
