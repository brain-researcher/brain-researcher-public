...
- Loader: `src/brain_researcher/services/br_kg/etl/loaders/openmed_pgc_hf_loader.py`
- Top-loci overlay: `src/brain_researcher/services/br_kg/etl/loaders/gwas_catalog_top_loci_loader.py`
- Derived disease-region materializer: `src/brain_researcher/services/br_kg/spatial/disease_trait_region_materializer.py`
- Live ingest script: `scripts/br-kg/run_openmed_pgc_live_ingest.py`
...
```bash
python scripts/br-kg/run_openmed_pgc_live_ingest.py --skip-top-loci
```
...
```bash
python scripts/br-kg/run_openmed_pgc_live_ingest.py --max-loci-per-disorder 20
```
...
```bash
pytest -q \
  tests/unit/br-kg/test_bulk_loader_entity_validator.py \
  tests/unit/br-kg/test_db_schema.py \
  tests/unit/br-kg/test_disease_trait_region_materializer.py \
  tests/unit/br-kg/test_gwas_catalog_top_loci_loader.py \
  tests/unit/br-kg/test_gwas_graph_schema.py \
  tests/unit/br-kg/test_openmed_pgc_hf_loader.py \
  tests/unit/br-kg/test_query_service.py \
  tests/services/br-kg/test_bulk_loader.py
```
