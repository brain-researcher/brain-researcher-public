...
**File**: `/services/neurokg/utils/node_label_linker.py`
...
**File**: `/services/neurokg/etl/mappers/cross_source_linker.py`
...
**File**: `/scripts/neurokg/link_duplicate_nodes.py`
...
**File**: `/scripts/neurokg/init_database.py`
...
**File**: `/services/neurokg/etl/load_all_openneuro_datasets.py`
...
**File**: `/scripts/neurokg/scheduled_cross_linker.py`
...
**Setup Script**: `/scripts/neurokg/setup_cron_linker.sh`
...
**File**: `/scripts/neurokg/ttl_edge_cleanup.py`
...
**Setup Script**: `/scripts/neurokg/setup_cron_ttl_cleanup.sh`
...
**File**: `/services/neurokg/api/mapping_review_api.py`
...
#### b. Web UI
**File**: `/services/neurokg/ui/mapping_review.html`
...
```bash
python scripts/neurokg/link_duplicate_nodes.py --database data/neurokg/db/neurokg_full.db
```
