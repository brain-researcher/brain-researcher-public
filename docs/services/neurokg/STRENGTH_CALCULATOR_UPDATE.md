...
python scripts/neurokg/calculate_strength.py --update-db --dry-run --limit 10

# Actually update the database
python scripts/neurokg/calculate_strength.py --update-db

# Update with limit
python scripts/neurokg/calculate_strength.py --update-db --limit 100
```
...
python scripts/neurokg/calculate_strength.py "working memory" "DLPFC" --coords-file coords.csv

# JSON output
python scripts/neurokg/calculate_strength.py "working memory" "DLPFC" --output json
```
...
python scripts/neurokg/calculate_strength.py --update-db --db-path /path/to/db
```
...
python scripts/neurokg/calculate_strength.py "working memory" "dorsolateral prefrontal cortex"

# Test database update mode
python scripts/neurokg/calculate_strength.py --update-db --dry-run --limit 5
```
