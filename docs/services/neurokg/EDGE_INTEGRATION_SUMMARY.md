...
**Script**: `scripts/neurokg/integrate_coordinate_relationships.py`
...
**Script**: `scripts/neurokg/integrate_study_concept_relationships.py`
**Loaders**:
...
**Script**: `scripts/neurokg/integrate_ontology_relationships.py`
...
**Script**: `scripts/neurokg/integrate_statistical_maps.py`
...
**Script**: `scripts/neurokg/integrate_subject_relationships.py`
...
python scripts/neurokg/integrate_coordinate_relationships.py --database path/to/db

# 2. Ontological relationships
python scripts/neurokg/integrate_ontology_relationships.py --database path/to/db

# 3. Study-concept relationships
python scripts/neurokg/integrate_study_concept_relationships.py --database path/to/db

# 4. Statistical map relationships
python scripts/neurokg/integrate_statistical_maps.py --database path/to/db

# 5. Subject-level relationships
python scripts/neurokg/integrate_subject_relationships.py --database path/to/db
```

### Initializing New Database

The `scripts/neurokg/init_database.py` script automatically integrates all relationship types when loading data:

```bash
# Full database with all relationships
python scripts/neurokg/init_database.py --full

# Resume loading if interrupted
python scripts/neurokg/init_database.py --resume
```
...
```bash
python scripts/neurokg/integrate_coordinate_relationships.py --analyze
python scripts/neurokg/integrate_study_concept_relationships.py --analyze
# etc.
```
