...
describe('/api/br-kg/[...path] route', () => {
  ...
  it('proxies legacy root subgraph requests without injecting /api', async () => {
    ...
    const req = new NextRequest('http://localhost/api/br-kg/subgraph?label=Concept&name=wm')
  ...
  it('proxies legacy root graphql requests without injecting /api', async () => {
    ...
    const req = new NextRequest('http://localhost/api/br-kg/graphql', {
      method: 'POST',
