...
class DataPathConfig:
    ...
    def get_path(
        self, source: str, dataset: str | None = None, fallback: bool = True
    ) -> Path | None:
    ...
    def _find_fallback(self, source: str, dataset: str | None) -> Path | None:
...
def get_data_path(
    source: str, dataset: str | None = None, fallback: bool = True
) -> Path | None:
