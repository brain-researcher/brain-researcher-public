...
class AllenBrainClient:
    ...
    def __init__(self, cache_dir: str | None = None):
        ...
        try:
            ...
            try:
                ...
                fallback_root.mkdir(parents=True, exist_ok=True)
            fallback = Path(
                tempfile.mkdtemp(prefix="allen_cache_", dir=str(fallback_root))
            )
            logger.warning(
    ...
    def get_expression_data(
        self, donor_id: str, gene_symbols: list[str]
    ) -> dict[str, Any]:
    ...
    def _get_probe_expression(
        self, donor_id: str, probe_ids: list[int]
    ) -> list[dict[str, Any]]:
    ...
    def _get_sample_expression(
        ...
        return {"donor_id": donor_id, "genes": gene_symbols, "expression": expression}
