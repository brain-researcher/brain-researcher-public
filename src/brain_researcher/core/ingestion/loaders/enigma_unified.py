...
class ENIGMAUnifiedLoader:
    ...
    def load_working_groups(
        self, groups: Optional[List[str]] = None, demo_mode: bool = False
    ) -> Dict[str, Any]:
    ...
    def load_meta_analysis_results(
        self, analysis_types: Optional[List[str]] = None, demo_mode: bool = False
    ) -> Dict[str, Any]:
    ...
    def load_brain_measures(
        self, measure_types: Optional[List[str]] = None, demo_mode: bool = False
    ) -> Dict[str, Any]:
    ...
    def link_publications(
        self, pubmed_ids: Optional[List[str]] = None
    ) -> Dict[str, Any]:
