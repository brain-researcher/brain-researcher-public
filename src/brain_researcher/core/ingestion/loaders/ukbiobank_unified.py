...
class UKBiobankUnifiedLoader:
    ...
    def load_phenotype_data(
        self, fields: Optional[List[str]] = None, demo_mode: bool = False
    ...
    def load_imaging_metrics(
        self, modalities: Optional[List[str]] = None, demo_mode: bool = False
    ) -> Dict[str, Any]:
    ...
    def load_genetic_markers(
        self, marker_types: Optional[List[str]] = None, demo_mode: bool = False
    ) -> Dict[str, Any]:
