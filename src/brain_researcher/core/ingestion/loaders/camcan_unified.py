...
class CamCANUnifiedLoader:
    ...
    def load_participants(
        self, participants_file: Optional[str] = None, demo_mode: bool = False
    ) -> Dict[str, Any]:
    ...
    def load_cognitive_measures(
        self, cognitive_file: Optional[str] = None, demo_mode: bool = False
    ) -> Dict[str, Any]:
    ...
    def load_lifestyle_factors(
        self, lifestyle_file: Optional[str] = None, demo_mode: bool = False
    ) -> Dict[str, Any]:
