...
def save_analysis_bundle(job: Any, output_dir: Path) -> None:
    ...
    files = AnalysisBundleFiles(
        ...
        user_docs_index_md=user_bundle_files.get("user_docs_index_md"),
        user_mcp_md=user_bundle_files.get("user_mcp_md"),
        user_operations_md=user_bundle_files.get("user_operations_md"),
    ...
    for role, field_name in (
        ...
        ("user_docs_index", "user_docs_index_md"),
        ("user_mcp", "user_mcp_md"),
        ("user_operations", "user_operations_md"),
