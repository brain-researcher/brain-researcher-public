...
from .error_handler import ServiceType
...
class ServiceHealthMonitor:
    ...
    async def get_service_health(self, service_name: str) -> HealthCheck | None:
...
async def initialize_health_monitoring(
    endpoints: list[ServiceEndpoint] | None = None,
    custom_alert_handlers: list[Callable] | None = None,
):
