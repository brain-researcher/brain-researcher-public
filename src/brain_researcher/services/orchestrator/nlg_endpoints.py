...
class UserProfileUpdate(BaseModel):
    ...
    preferred_explanation_level: Optional[str] = Field(
    ...
    # Preferences
    detailed_methodology: Optional[bool] = Field(
    ...
    visual_descriptions: Optional[bool] = Field(
        default=None, description="Include visual descriptions"
    )
    statistical_details: Optional[bool] = Field(
    ...
    time_preferences: Optional[str] = Field(
        default=None, description="Time preferences"
    )
...
class FeedbackRequest(BaseModel):
    ...
    confusion_points: Optional[List[str]] = Field(
