...
class BrainCoordinate:
    ...
    hemisphere: str | None = None  # left, right, bilateral
...
class BrainAnnotation:
    ...
    # Spatial information
    coordinate: BrainCoordinate | None = None
...
class BrainAnnotationManager:
    ...
    async def get_document_annotations(
        self, document_id: str, filter_criteria: dict[str, Any] | None = None
    ...
    async def find_overlapping_annotations(
        self, region: BrainRegion, document_id: str | None = None
    ) -> list[BrainAnnotation]:
