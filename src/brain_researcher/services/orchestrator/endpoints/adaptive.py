...
class SystemMetricsResponse(BaseModel):
    ...
    gpu_usage: float | None = Field(None, description="GPU usage percentage")
    gpu_memory: float | None = Field(None, description="GPU memory usage percentage")
...
class StrategySelectionResponse(BaseModel):
    ...
    previous_strategy: str | None = Field(None, description="Previous strategy")
...
class PerformanceMetricsResponse(BaseModel):
    ...
    system: dict[str, Any] | None = Field(None, description="System metrics")
    scheduler: dict[str, Any] | None = Field(None, description="Scheduler metrics")
    strategy: dict[str, Any] | None = Field(None, description="Strategy metrics")
    performance: dict[str, Any] | None = Field(None, description="Performance history")
