...
class TraversalConstraints:
    ...
    forbidden_edge_types: set[str] | None = None
...
class MultiHopQueryEngine:
    ...
    def _build_target_filter(
        self, target_node_id: str | None, path_var: str = "end"
    ) -> str:
    ...
    def _get_cached_result(self, cache_key: str) -> TraversalResult | None:
