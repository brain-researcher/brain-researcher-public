...
class QueryOptimizer:
    ...
    def optimize_query(self, query: str, params: dict | None = None) -> QueryPlan:
    ...
    def _generate_query_id(self, query: str, params: dict | None) -> str:
    ...
    def _optimize_index_lookup(self, query: str) -> dict[str, Any]:
        ...
        for var, label, prop, _value in matches:
