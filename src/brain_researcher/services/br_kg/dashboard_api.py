...
def generate_mock_metrics():
    ...
    queue_status = {"running": 0, "queued": 0, "completed": 0, "failed": 0}

    # Cluster status - basic structure, orchestrator will override with real data
    cluster_status = {
        "nodes": {"total": 0, "active": 0, "idle": 0, "maintenance": 0},
        "cpus": {"total": 0, "allocated": 0, "available": 0},
        "memory": {"total": 0, "allocated": 0, "available": 0},
    }
...
def get_project_details(project_id):
    ...
    try:
        ...
        project = {
            ...
            "progress": 75,
            "subjects": {"total": 120, "completed": 90, "inProgress": 20, "failed": 10},
            "pipelines": [
            ...
            activities.append(
                {
                    ...
                    "timestamp": (
                        now - timedelta(minutes=activity_idx * 30)
                    ).isoformat(),
                    "user": random.choice(
                        [
                            "Dr. Sarah Chen",
                    ...
                    "type": random.choice(
                        ["start", "complete", "upload", "modify", "export"]
                    ),
                    "details": {
    ...
    try:
        summary = {
            ...
            "alerts": [
                {
                    "level": "warning",
                    "message": "Primary storage at 48% capacity",
                    "timestamp": datetime.now().isoformat(),
                },
                {
                    "level": "info",
                    "message": "Scheduled maintenance on GPU node 3 tomorrow",
                    "timestamp": datetime.now().isoformat(),
                },
            ],
            "recentAchievements": [
