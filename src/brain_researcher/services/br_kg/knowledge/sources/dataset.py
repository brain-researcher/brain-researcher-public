...
Wraps the shared dataset resolution helpers to provide dataset matches as
            ...
            for dataset in catalog:
                ...
                if filters:
                    if "modalities" in filters:
                        required = {m.lower() for m in filters["modalities"]}
                        available = {m.lower() for m in (dataset.modalities or [])}
