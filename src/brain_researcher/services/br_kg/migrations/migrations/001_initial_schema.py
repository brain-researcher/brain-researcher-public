...
class Migration_001(Migration):
    ...
    def __init__(self):
        super().__init__(
            version="001_initial_schema", description="Create initial BR-KG schema"
        )
    ...
    def up(self, db):
        ...
        """
        # Check if this is a SQLite connection or BRKGGraphDB
        if isinstance(db, sqlite3.Connection):
            conn = db
        else:
            # For BRKGGraphDB, get the underlying connection
