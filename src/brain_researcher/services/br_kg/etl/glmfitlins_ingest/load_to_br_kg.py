...
def load_to_br_kg(
    ...
    When db_path is provided, uses the SQLite-backed BRKGGraphDB (useful for
    offline runs and unit tests).
    """

    # Initialize database
    if db_path:
        db = BRKGGraphDB(str(db_path))
...
if __name__ == "__main__":
    ...
    load_to_br_kg(args.manifest, args.contrasts, args.db_path)
