...
- `configs/br-kg/edge_scoring.yaml` - Methods and thresholds per node type
- `configs/br-kg/thresholds.yaml` - SAME_AS confidence thresholds
...
```python
from brain_researcher.services.br_kg.bulk_loader import LoaderConfig, BulkLoader
