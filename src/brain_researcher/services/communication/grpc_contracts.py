...
class BrainResearcherServiceStub:
    ...
    def __init__(self, channel, service_name: str, auth_token: str | None = None):
...
class ServiceDiscoveryIntegration:
    ...
    async def get_client(
        self, service_name: str, auth_token: str | None = None
...
async def create_grpc_client(
    service_name: str, service_url: str, auth_token: str | None = None
) -> BrainResearcherServiceStub:
