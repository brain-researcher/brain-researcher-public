...
class GNNConnectivityArgs(BaseModel):
    ...
    connectivity_file: str | None = Field(
        default=None, description="Connectivity matrix path"
    )
    timeseries_file: str | None = Field(
    ...
    threshold: float | None = Field(default=None, description="Edge threshold")
    sparsity: float | None = Field(default=None, description="Target sparsity fraction")
    ...
    n_classes: int | None = Field(default=2, description="Number of classes")
