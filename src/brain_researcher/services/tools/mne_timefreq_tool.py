...
class MNETimeFreqArgs(BaseModel):
    ...
    connectivity_pairs: list[tuple[str, str]] | None = Field(
    ...
    bands: dict[str, tuple[float, float]] | None = Field(
        default=None,
...
class MNETimeFreqTool(NeuroToolWrapper):
    ...
    def _run(
        ...
        freq_min: float | None = 1.0,
        freq_max: float | None = 40.0,
        n_freqs: int | None = 30,
        n_cycles: float | list[float] | None = 7.0,
        use_fft: bool = True,
        ...
        connectivity_pairs: list[tuple[str, str]] | None = None,
