...
``brain_researcher.services.agent.plugin_integration`` for backward
compatibility.
"""
...
class PluginDataSourceTool(BRKGToolWrapper):
...
class AgentPluginManager:
    ...
    def __init__(self, config: AgentPluginConfig | None = None):
