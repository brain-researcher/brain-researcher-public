...
class FSLFIXArgs(BaseModel):
    ...
    hand_labels_file: str | None = Field(
        default=None,
...
class FSLFIXTool(NeuroToolWrapper):
    ...
    def _train_classifier(
        ...
        try:
            ...
            with open(training_list, "w") as f:
                for feat_dir, labels in zip(feat_dirs, hand_labels, strict=False):
    ...
    def _run(
        ...
        hand_labels_file: str | None = None,
        ...
        **kwargs,
        ...
        try:
            ...
            if train_mode:
                ...
                # Load hand labels
                with open(hand_labels_file) as f:
