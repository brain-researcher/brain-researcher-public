...
class MetaAnalysisArgs(BaseModel):
    ...
    study_labels_file: str | None = Field(
        default=None, description="Path to study labels/IDs"
    )
    sample_sizes_file: str | None = Field(
    ...
    ale_fwhm: float | None = Field(default=None, description="FWHM for ALE kernel (mm)")
    ...
    subgroup_variable: str | None = Field(
...
class MetaAnalysisTool(NeuroToolWrapper):
    ...
    def _run(
        ...
        study_labels_file: str | None = None,
        sample_sizes_file: str | None = None,
        images_dir: str | None = None,
        contrast_files: list[str] | None = None,
        variance_files: list[str] | None = None,
        effect_sizes_file: str | None = None,
        standard_errors_file: str | None = None,
        method: str = "ALE",
        ale_kernel: str = "gaussian",
        ale_fwhm: float | None = None,
