...
from .drift_detector import DriftDetection, MultimodalDriftDetector
...
class OnlineLearner:
    ...
    def end_learning_session(self) -> LearningSession | None:
    ...
    def load_state(self, filepath: str) -> None:
        ...
        # Load main state
        with open(f"{filepath}_learner.json") as f:
            state = json.load(f)
