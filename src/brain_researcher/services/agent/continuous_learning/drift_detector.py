...
class DriftDetector:
    ...
    def add_reference_data(self, data: float | np.ndarray | dict[str, Any]) -> None:
        """Add data to reference window (baseline)."""
        self.reference_data.append(data)

    def add_data(self, data: float | np.ndarray | dict[str, Any]) -> DriftDetection:
...
class DataDistributionDriftDetector(DriftDetector):
    ...
    def add_sample(self, sample: np.ndarray | dict[str, Any]) -> DriftDetection:
        """Add data sample."""
...
class MultimodalDriftDetector:
    ...
    def __init__(
        self,
        performance_detector: PerformanceDriftDetector | None = None,
        distribution_detector: DataDistributionDriftDetector | None = None,
