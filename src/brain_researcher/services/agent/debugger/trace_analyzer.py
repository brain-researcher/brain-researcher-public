...
class ReplayEngine:
    ...
    def get_replay_state(self, replay_id: str) -> dict | None:
...
class TraceAnalyzer:
    ...
    async def analyze_trace(self, trace_id: str) -> TraceAnalysis | None:
    ...
    async def replay_trace(self, trace_id: str, speed: float = 1.0) -> str | None:
        """Start replaying a trace"""
        if trace_id not in self.traces:
            return None
