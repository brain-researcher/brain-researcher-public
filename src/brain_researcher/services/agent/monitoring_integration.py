...
def monitor_tool(tool_name):
    return get_monitoring_integration().monitor_tool_execution(tool_name)


def monitor_cache(operation):
    return get_monitoring_integration().monitor_cache_operation(operation)
