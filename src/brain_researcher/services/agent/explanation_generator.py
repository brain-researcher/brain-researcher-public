...
class ExplanationContext:
    ...
    user_expertise: ExpertiseLevel | None = None
    ...
    time_constraints: str | None = None  # "brief", "detailed", "comprehensive"
    audience_type: str | None = None  # "clinical", "research", "educational"
...
class ExplanationResult:
    ...
    language: Language
    structured: dict[str, str] | StructuredExplanation | None = None
    citations: list[str] = field(default_factory=list)
...
class ExplanationGenerator:
    ...
    def _extract_primary_p_value(self, analysis_result: dict[str, Any]) -> float | None:
    ...
    def _create_simple_interpretation(self, analysis_result: dict[str, Any]) -> str:
        ...
        if "task" in analysis_type.lower():
            return "this brain area is more active during the specific task"
        elif "rest" in analysis_type.lower():
            return "this brain area shows different activity patterns at rest"
        elif "group" in analysis_type.lower():
            return "there are differences between groups in this brain area"
        else:
