...
from brain_researcher.services.shared.r2toolsagent_base_backend import JobState


def parse_squeue_output(
    slurm_job_id: str, stdout: str
) -> tuple[JobState | None, datetime | None]:
...
def parse_sacct_output(
    slurm_job_id: str, stdout: str
) -> tuple[JobState | None, datetime | None, datetime | None, int | None]:
