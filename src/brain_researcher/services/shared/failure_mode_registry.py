...
DEFAULT_REGISTRY_PATH = (
    _REPO_ROOT / "configs" / "br-kg" / "scientific_review_failure_mode_registry.yaml"
)
...
def render_failure_mode_registry_markdown(registry: FailureModeRegistry) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        "<!-- GENERATED from configs/br-kg/scientific_review_failure_mode_registry.yaml. Do not edit by hand. -->",
        "",
