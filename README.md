...
| Worked claim-record example | `examples/auditable_claim_record/` | Runnable tutorial that generates claim-card JSON. It is not a manifest-backed reproducibility pack. |
...
| `examples/auditable_claim_record/` | Worked generator tutorial; no pack manifest and no `verify.py` contract |
