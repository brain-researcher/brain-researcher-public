...
run_test "canonical Neurosynth downloader help" "python scripts/data/download_neurosynth_data.py --help"
run_test "canonical Neurosynth converter help" "python scripts/data/convert_neurosynth.py --help"
...
echo "------------------"
check_file "canonical Neurosynth downloader" "scripts/data/download_neurosynth_data.py"
check_file "canonical Neurosynth converter" "scripts/data/convert_neurosynth.py"
